...
%%%%%% Load dataset%%%%%%
% ncs data
ncs_path = '/Users/aniszahedifard/Desktop/Sleep Hypothesis/Data/hc1/hc1.ncs'; %%change path to your desired path
cfg            = [];
cfg.dataset    = ncs_path;
ncs_data       = ft_preprocessing(cfg);
%%%%Load important event file (epochs.mat) %%%%
load '/Users/aniszahedifard/Desktop/Sleep Hypothesis/Data/doi_10.5061_dryad.7d7wm37rn__v3/epochs.mat';
